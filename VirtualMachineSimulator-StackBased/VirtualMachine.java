...
public class VirtualMachine extends JComponent
{
   ...
   int d, a, x, y;
   private int[] memory;
   private String descrMessage = "To run the program, you choose a text file with instruction commands. All commands in a file need to be separated by a single space in between.";
   ...
   {
      //System.out.println("");
      JOptionPane.showMessageDialog(null, descrMessage);
      String textLine;
             ...
             try
               {
                  ...
                  do
                  {
                     ...
                     int i = 0;
                     String[] stringInstructions = textLine.split(" ");
                     for (String instruction: stringInstructions)
                     {
                        memory[i] = Integer.parseInt(instruction);
                        i++;
                     }
                  }
                  while (textLine != null );
